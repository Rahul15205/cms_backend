...
<style>${styles}
  ...
  .footer-tagline strong { color: var(--brand-dark); font-weight: 600; }
  .footer-right {
    flex-shrink: 0;
    text-align: right;
    display: flex;
  ...
  .footer-date-line { font-size: 11px; color: var(--muted); white-space: nowrap; }
  .footer-domain-line { font-size: 11px; color: var(--brand-dark); font-weight: 500; }
  ...
  .chart-card-donut .donut-num { font-size: 20px; }
...
<div class="page">
  ...
  <div class="report-footer">
    <div class="footer-left">
      ${renderProteccioLogo(20)}
      <span class="footer-tagline">Generated by <strong>Proteccio Data</strong> &middot; Consent Management System</span>
    </div>
    <div class="footer-right">
      <span class="footer-date-line">${generatedFooter}</span>
      <span class="footer-domain-line">${escapeHtml(data.baseDomain)}</span>
    </div>
  </div>
</div>

...
export declare class RightsRequestsController {
    ...
    addEvidence(id: string, dto: CreateEvidenceItemDto, req: any, file?: Express.Multer.File): Promise<{
        id: string;
        caseNumber: string;
        category: string;
        fileName: string;
    ...
    verifyEvidence(requestId: string, id: string, verified: boolean, req: any): Promise<{
        id: string;
        caseNumber: string;
        category: string;
        fileName: string;

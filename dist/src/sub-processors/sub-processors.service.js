...
exports.SubProcessorsService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
let SubProcessorsService = class SubProcessorsService {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(createSubProcessorDto) {
    ...
    async findOne(id) {
        ...
        if (!subProcessor) {
            throw new common_1.NotFoundException(`SubProcessor with ID ${id} not found`);
        }
        return subProcessor;
    }
    async update(id, updateSubProcessorDto) {
...
exports.SubProcessorsService = SubProcessorsService;
exports.SubProcessorsService = SubProcessorsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], SubProcessorsService);
//# sourceMappingURL=sub-processors.service.js.map